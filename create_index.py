...
parser.add_argument("--index_factory", default="IMI2x12,PQ16", type=str)
...
if not index_factory.startswith("Flat"):

    index = faiss.index_factory(
        args.row_size, index_factory, faiss.METRIC_INNER_PRODUCT
    )
    ...
    index = faiss.index_factory(ROW_SIZE, index_factory, faiss.METRIC_INNER_PRODUCT)
